...
export default function AdminNavbar({
  ...
  return (
    <nav
      ref={navRef}
      className="sticky top-0 z-40 bg-[#0a0e17]/90 backdrop-blur-2xl border-b border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.6)] select-none font-sans"
    >
      ...
      <div className="max-w-[1680px] mx-auto px-3 sm:px-5 h-15 flex items-center justify-between gap-2.5">
        ...
        {/* Left Section: Brand Logo & Nav Menu Items */}
        <div className="flex items-center gap-2.5 lg:gap-4 flex-1 min-w-0">
          ...
          {/* Navigation Buttons: Clean without unwanted horizontal scrollbars */}
          <div className="flex items-center gap-1 text-[11.5px] font-semibold overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden py-1">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          ...
          {currentUser && (
            <div className="hidden xl:flex items-center gap-2 pl-2 border-l border-white/10">
              ...
              <span className={`px-2 py-0.5 rounded-full text-[8.5px] font-mono font-extrabold uppercase border ${getRoleBadge(currentUser.role)}`}>
                {currentUser.role}
              </span>
            </div>
          )}
