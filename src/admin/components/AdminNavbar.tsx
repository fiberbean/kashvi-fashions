    ...
    >
      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-6 h-15 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold">
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-1.5 rounded-2xl transition-all cursor-pointer border ${
              ...
              {/* Masters Floating Glass Dropdown Menu */}
              {openDropdown === 'masters' && (
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Auto-Sync Neon Capsule */}
          <button
            type="button"
            onClick={onManualSync}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 text-[10.5px] font-mono text-white transition-all cursor-pointer active:scale-95 shadow-inner"
          ...
          >
            ...
            <span className="font-semibold tracking-wide">Sync Stream</span>
          ...
          {/* Lock / Logout Neon Button */}
          <button
            type="button"
            onClick={onLogout}
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-2xl bg-[#ff6b6b]/15 border border-[#ff6b6b]/30 text-[#ff6b6b] hover:bg-[#ff6b6b]/25 hover:shadow-[0_0_15px_rgba(255,107,107,0.3)] text-[10.5px] font-bold transition-all cursor-pointer"
