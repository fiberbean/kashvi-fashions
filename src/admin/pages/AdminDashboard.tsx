...
export default function AdminDashboard({
  ...
  // Re-fetch on external sync click
  useEffect(() => {
  ...
  return (
    <div className="space-y-4.5 animate-in fade-in duration-200 select-none font-sans">
      ...
      {/* 2. Compact Live Order Stream Table */}
            ...
            <table className="w-full text-left text-xs font-sans">
              ...
              <tbody className="divide-y divide-[#edf2ef]">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="py-8 text-center text-neutral-400 font-medium">
                      No orders placed yet. Incoming orders stream live automatically.
                    </td>
                  </tr>
                ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2.5 px-4">
                          <div className="font-bold text-[#0c2b22] leading-tight">{ord.customer_name || 'Guest User'}</div>
              ...
              <tbody className="divide-y divide-[#edf2ef]">
                {abandonedCarts.map((cart) => (
                  <tr key={cart.id} className="hover:bg-[#fcfaf4] transition-colors">
                    ...
                    <td className="py-2.5 px-4 text-right">
                      <a
                        href={`https://wa.me/91${cart.customer_phone.replace(/\D/g, '')}?text=Hi%20${encodeURIComponent(cart.customer_name)},%20we%20noticed%20you%20left%20some%20exclusive%20items%20in%20your%20Kashvi%20cart!`}
                        target="_blank"
